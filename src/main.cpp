...
int main(int argc, char *argv[])
{
    ...
    QTimer::singleShot(1000, [&]() {
        splash.showMessage(QObject::tr("正在加载 3D 引擎..."), Qt::AlignCenter | Qt::AlignBottom, Qt::white);
    });
    
    QTimer::singleShot(2000, [&]() {
        splash.showMessage(QObject::tr("正在初始化用户界面..."), Qt::AlignCenter | Qt::AlignBottom, Qt::white);
    });
