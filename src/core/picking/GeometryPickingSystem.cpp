...
Geo3D::Ptr GeometryPickingSystem::findGeometryFromNodePath(const osg::NodePath& nodePath)
{
...
PickResult GeometryPickingSystem::analyzeFaceIntersection(const osgUtil::LineSegmentIntersector::Intersection& intersection)
{
    ...
    Geo3D::Ptr geometry = findGeometryFromNodePath(intersection.nodePath);
