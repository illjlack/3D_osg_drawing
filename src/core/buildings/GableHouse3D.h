...
private:
    ...
    void buildGableHouseStageGeometry();
    void calculateGableHouseParameters();
    bool isValidGableHouseConfiguration() const;
    
private:
    float m_width = 4.0f;
    float m_length = 6.0f;
    float m_height = 3.0f;
    float m_gableHeight = 1.5f;
    ...
    float m_calculatedGableHeight = 0.0f;
}; 